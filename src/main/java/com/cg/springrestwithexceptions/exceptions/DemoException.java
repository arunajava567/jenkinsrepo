package com.cg.springrestwithexceptions.exceptions;
...
public class DemoException {
	...
	@ExceptionHandler(value = {CountryNotFoundException.class})
	  protected String handleConflict(Exception ex, HttpServletRequest req) {
        String bodyOfResponse = ex.getMessage();// "Country with this id not present";
        String uri = req.getRequestURL().toString();
        return   bodyOfResponse; //new ErrorInfo(uri,bodyOfResponse);
    }
